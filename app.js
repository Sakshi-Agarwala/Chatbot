let apikey= "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";

document.getElementById('input_icon').addEventListener('click', () => {
    if (document.getElementById('input').value != '') {
        document.getElementsByClassName('search')[0].style.boxShadow = `5px 5px 10px rgb(0, 0, 0, .5), inset 5px 5px 10px rgb(0, 0, 0, .5)`;
        ...
        document.getElementsByClassName('search')[0].style.boxShadow = `5px 5px 10px rgb(0, 0, 0, .5), inset 5px 5px 10px rgb(255, 0, 0, .5)`;
    }
})
